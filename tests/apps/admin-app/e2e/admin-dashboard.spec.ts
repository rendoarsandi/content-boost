...
test.describe('Admin Dashboard E2E Test', () => {
  ...
  test('Should navigate to user management', async ({ page }) => {
    ...
    await expect(
      page.locator('select, button:has-text("Filter")')
    ).toBeVisible();
  ...
  test('Should handle user ban/unban actions', async ({ page }) => {
    ...
    const userActions = page
      .locator('button:has-text("Ban"), button:has-text("Unban")')
      .first();
  ...
  test('Should navigate to financial oversight', async ({ page }) => {
    ...
    await expect(
      page.locator('h1:has-text("Financial Management")')
    ).toBeVisible();
  ...
  test('Should handle financial oversight actions', async ({ page }) => {
    ...
    const filterSelect = page
      .locator('select[name*="filter"], input[name*="search"]')
      .first();
    ...
    const payoutActions = page
      .locator('button:has-text("Approve Payout"), button:has-text("Process")')
      .first();
  ...
  test('Should handle system alerts', async ({ page }) => {
    ...
    const alertActions = page
      .locator('button:has-text("Acknowledge"), button:has-text("Resolve")')
      .first();
