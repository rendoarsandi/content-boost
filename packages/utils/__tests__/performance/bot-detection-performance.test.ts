...
import { detectBot, BotDetectionConfig, ViewMetrics } from '../src/bot-detection';
...
describe('Bot Detection Algorithm Performance Tests', () => {
  ...
  test('Performance with small dataset (30 data points)', () => {
    ...
    const result = detectBot('test-promoter', 'test-campaign', normalData, config);
  ...
  test('Performance with medium dataset (1440 data points)', () => {
    ...
    console.log(`Medium dataset (1440 points) execution time: ${end - start}ms`);
  ...
  test('Performance with large dataset (10080 data points)', () => {
    ...
    console.log(`Large dataset (10080 points) execution time: ${end - start}ms`);
  ...
  test('Performance with spike detection', () => {
    ...
    const start = performance.now();
    const result = detectBot('test-promoter', 'test-campaign', spikeData, config);
    const end = performance.now();
  ...
  test('Performance with mixed data patterns', () => {
    ...
    const start = performance.now();
    const result = detectBot('test-promoter', 'test-campaign', mixedData, config);
    const end = performance.now();
