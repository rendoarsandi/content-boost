...
export class CampaignTemplateService {
  ...
  async getTemplates(
    category?: string
  ): Promise<{ templates: CampaignTemplate[] | null; error: string | null }> {
    try {
  ...
  async createCampaignFromTemplate(
    request: CreateCampaignFromTemplate
  ): Promise<{ campaign: any | null; error: string | null }> {
    try {
      // Get the template
      const { template, error: templateError } = await this.getTemplate(
        request.template_id
      );
      if (templateError) {
      ...
      let title =
        request.customizations.title || template.template_config.title_template;
      let description =
        request.customizations.description ||
      ...
      const campaignData = {
        ...
        requirements: {
          ...
          additional_requirements:
            request.customizations.additional_requirements || '',
        },
      };
  ...
  async seedDefaultTemplates(): Promise<{
    success: boolean;
    error: string | null;
  }> {
    ...
    >[] = [
      {
        ...
        description:
          'Perfect for introducing a new product to the market with maximum impact.',
        category: 'product_launch',
        template_config: {
          title_template:
            '🚀 Introducing {{PRODUCT_NAME}} - Revolutionary {{CURRENT_YEAR}} Launch!',
          description_template:
            "We're excited to launch {{PRODUCT_NAME}} this {{CURRENT_MONTH}}! Help us spread the word about this innovative solution that will transform how people [describe main benefit]. Join our exclusive launch campaign and be among the first to share this amazing product with your audience.",
          default_budget: 5000,
      ...
      },
      {
        ...
        description:
          'Build recognition and establish your brand presence in the market.',
        category: 'brand_awareness',
        template_config: {
          title_template:
            'Get to Know {{COMPANY_NAME}} - {{CURRENT_YEAR}} Brand Story',
          description_template:
            "We're on a mission to [describe company mission]. This {{SEASON}}, help us share our story and connect with people who share our values. Join our brand awareness campaign and introduce your audience to who we are and what we stand for.",
          default_budget: 3000,
      ...
      },
      {
        ...
        description:
          'Capitalize on seasonal trends and holidays for timely promotional campaigns.',
        category: 'seasonal',
        template_config: {
          title_template:
            '{{SEASON}} {{CURRENT_YEAR}} Special - Limited Time Offer!',
          description_template:
            "This {{SEASON}} season calls for something special! We're offering exclusive deals and seasonal products that your audience will love. Help us make this {{CURRENT_MONTH}} memorable with promotions that capture the {{SEASON}} spirit.",
          default_budget: 4000,
          ...
          promotional_materials: [
            ...
            },
            {
              ...
              required: true,
              description:
                'Sale banners and promotional graphics with seasonal design',
            },
            {
      ...
      },
      {
        ...
        description:
          'Encourage customers to create content featuring your brand or products.',
        category: 'user_generated_content',
        template_config: {
          title_template:
            'Show Us Your {{PRODUCT_NAME}} Style - {{CURRENT_YEAR}} UGC Challenge!',
          description_template:
            "We love seeing how our customers use {{PRODUCT_NAME}} in their daily lives! Join our user-generated content campaign and encourage your audience to share their own creative content. Let's build a community of brand advocates together.",
          default_budget: 2500,
          ...
          promotional_materials: [
            ...
            },
            {
              ...
              required: true,
              description:
                "Examples showing the type of content you're looking for",
            },
            {
              type: 'Prize Information',
              required: false,
              description:
                'Details about rewards or recognition for participants',
            },
          ],
          audience_targeting: {
            demographics: [
