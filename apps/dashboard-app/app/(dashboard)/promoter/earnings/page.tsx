  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 mt-2">Track your campaign earnings and payouts</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">Rp {earnings.monthlyEarnings.amount.toLocaleString()}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">Rp {earnings.recentEarnings.amount.toLocaleString()}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{earnings.totalViews.total.toLocaleString()}</div>
            <p className="text-xs text-gray-500 mt-1">{earnings.totalViews.legitimate} legitimate</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Your latest earnings and payout history</CardDescription>
        </CardHeader>
        <CardContent>
          {earnings.payouts.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-4">
                Start promoting campaigns to earn money and see your payouts here.
              </p>
