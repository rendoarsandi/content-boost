  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center space-x-4">
          ...
          {data.campaignPerformance.length > 0 && (
            <div>
              <label className="text-sm font-medium text-gray-700 mr-2">Campaign:</label>
              <select
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-gray-600">Bot Detection Rate</CardTitle>
          </CardHeader>
          <CardContent>
            <div className={`text-2xl font-bold ${getBotScoreColor(data.overview.botDetectionRate)}`}>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Likes: {data.overview.likeRate.toFixed(1)}% | Comments: {data.overview.commentRate.toFixed(1)}%
            </p>
          </CardContent>
        </Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-4 bg-green-50 rounded-lg">
              ...
              <p className="text-sm text-green-800 font-medium">Legitimate Records</p>
              <p className="text-xs text-green-600 mt-1">
                {((data.botDetection.legitimateRecords / data.botDetection.totalRecords) * 100).toFixed(1)}% of total
              </p>
            </div>
            ...
            <div className="text-center p-4 bg-red-50 rounded-lg">
              ...
              <p className="text-sm text-red-800 font-medium">Bot Records Detected</p>
            ...
            <div className="text-center p-4 bg-blue-50 rounded-lg">
              ...
              <p className="text-sm text-blue-800 font-medium">Average Bot Score</p>
              <Badge className={getBotScoreBadge(data.botDetection.avgBotScore)}>
                {data.botDetection.avgBotScore < 20 ? 'Excellent' : 
                 data.botDetection.avgBotScore < 50 ? 'Good' :
                 data.botDetection.avgBotScore < 80 ? 'Fair' : 'Poor'}
              </Badge>
            </div>
          </div>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            ...
            <ul className="text-sm text-blue-800 space-y-1">
              <li>• <strong>Bot Score 0-20:</strong> Excellent traffic quality, very low bot activity</li>
              <li>• <strong>Bot Score 20-50:</strong> Good traffic quality, minimal bot concerns</li>
              <li>• <strong>Bot Score 50-80:</strong> Fair traffic quality, some bot activity detected</li>
              <li>• <strong>Bot Score 80+:</strong> Poor traffic quality, high bot activity - earnings may be affected</li>
            </ul>
          </div>
        </CardContent>
      </Card>
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Rate: Rp {Number(campaign.ratePerView).toLocaleString()} per view
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-purple-600">
                        {campaign.legitimateViews > 0 
                          ? (((campaign.totalLikes + campaign.totalComments) / campaign.legitimateViews) * 100).toFixed(1)
                          : '0'
                        }%
                      </p>
                    </div>
      ...
      {data.campaignPerformance.length === 0 && (
        <Card>
          <CardContent className="text-center py-12">
            <div className="text-gray-400 text-6xl mb-4">📈</div>
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Campaign Data</h3>
            <p className="text-gray-600 mb-6">
              You don't have any approved campaigns with activity in the selected period.
            </p>
            <Button onClick={() => window.location.href = '/promoter/campaigns'}>
              Browse Campaigns
            </Button>
          </CardContent>
        </Card>
