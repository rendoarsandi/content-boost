...
export default async function PromoterApplicationsPage() {
  ...
  const { applications, viewStats } = await getPromoterApplications((session.user as any).id);
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">Track your campaign applications and performance</p>
        </div>
      ...
      {applications.length === 0 ? (
        ...
        <div className="space-y-6">
          ...
          {approvedApplications.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle className="text-green-700">Approved Applications</CardTitle>
                <CardDescription>
              ...
              <CardContent>
                <div className="space-y-4">
                  {approvedApplications.map(({ application, campaign, creator }) => {
                    const stats = viewStats.find(s => s.applicationId === application.id);
          ...
          {pendingApplications.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle className="text-yellow-700">Pending Applications</CardTitle>
                <CardDescription>
              ...
              <CardContent>
                <div className="space-y-3">
                  {pendingApplications.map(({ application, campaign, creator }) => (
                    <div key={application.id} className="border rounded-lg p-4 bg-yellow-50">
          ...
          {rejectedApplications.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle className="text-red-700">Rejected Applications</CardTitle>
                <CardDescription>
              ...
              <CardContent>
                <div className="space-y-3">
                  {rejectedApplications.map(({ application, campaign, creator }) => (
