  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-gray-600">Earnings (30 days)</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <Link href="/promoter/campaigns?filter=high-paying">
              <Button variant="outline" className="w-full">High-Paying Campaigns</Button>
            </Link>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <Link href="/promoter/applications?status=pending">
              <Button variant="outline" className="w-full">Pending Reviews</Button>
            </Link>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your promotion performance metrics</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
              <div>
                <p className="text-sm text-blue-600 font-medium">Total Legitimate Views</p>
                <p className="text-2xl font-bold text-blue-800">{stats.legitimateViews.toLocaleString()}</p>
              </div>
            ...
            <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
              <div>
                ...
                <p className="text-2xl font-bold text-green-800">Rp {stats.totalEarnings.toLocaleString()}</p>
              </div>
            ...
            <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
              <div>
                <p className="text-sm text-purple-600 font-medium">Completed Payouts</p>
                <p className="text-2xl font-bold text-purple-800">{stats.completedPayouts}</p>
              </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Overview of your campaign applications</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Approved Applications</span>
                <span className="font-semibold text-green-600">{stats.applications.approved || 0}</span>
              </div>
              <div className="flex justify-between items-center">
