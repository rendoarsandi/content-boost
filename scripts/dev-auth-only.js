...
async function runAuthDev() {
  ...
  const warningTimeout = setTimeout(() => {
    console.warn('⚠️  Auth App startup taking longer than expected (30 seconds)...');
    console.log('This is normal for Next.js development servers. Press Ctrl+C to stop.');
    console.log('If the server seems stuck, you can:');
    console.log('  1. Wait a bit longer (Next.js can take time on first startup)');
